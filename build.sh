...
CHAT_ID="${CHAT_ID}"
TOKEN="${TOKEN}"
export KBUILD_BUILD_USER=momenabdulrazekali
...
if [[ ! -d ${AK} ]]; then
  git clone https://github.com/momenabdulrazek/AnyKernel3 --no-tags --single-branch -b $AK_BRANCH ${AK}
fi
